...
namespace Shiftv.Views.Movies.Pages
{
    ...
    public sealed partial class TrendingMovies
    {
        ...
        public TrendingMoviesViewModel ViewModel
        {
            get { return (TrendingMoviesViewModel) DataContext; }
        }
        ...
        {
            var atBottom = _scrollViewer.HorizontalOffset >=
                           (_scrollViewer.ExtentWidth - _scrollViewer.ViewportWidth) - 200;
            if (atBottom)
            {
                ViewModel.LoadData();
