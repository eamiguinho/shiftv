...
{
    public sealed partial class MyWatchlistedMovies
    {
        ...
        public MyWatchlistedMoviesViewModel ViewModel { get { return (MyWatchlistedMoviesViewModel)DataContext; } }


        public MyWatchlistedMovies()
        {
            InitializeComponent();
