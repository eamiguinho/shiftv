...
using Shiftv.ViewModels.Network;

namespace Shiftv.Views.Network
{
    /// <summary>
    ...
    public sealed partial class UserProfileView : Page
    {
        ...
        public UserProfileViewModel ViewModel { get { return (UserProfileViewModel)DataContext; } }
        ...
        private void CalculateMarginTop()
        {
            ...
            ViewModel.MarginTopHeight = new Thickness(0, bounds.Height - 640, 0, 0);
        }
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            ViewModel.LoadUserData(e.Parameter as string);
        }
