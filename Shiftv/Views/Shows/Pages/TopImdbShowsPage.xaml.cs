...
{
    public sealed partial class TopImdbShowsPage
    {
        ...
        public TopImdbShowsPageViewModel ViewModel { get { return (TopImdbShowsPageViewModel)DataContext; } }


        public TopImdbShowsPage()
        {
            InitializeComponent();
