...
{
    public sealed partial class RecommendedShowsPage
    {
        ...
        public RecommendedShowsViewModel ViewModel { get { return (RecommendedShowsViewModel)DataContext; } }


        public RecommendedShowsPage()
        {
            InitializeComponent();
            _navigationHelper = new NavigationHelper(this);
            _navigationHelper.LoadState += navigationHelper_LoadState;
            _navigationHelper.SaveState += navigationHelper_SaveState;
            RecommendedView.Loaded += ItemGridViewOnLoaded;
            CalculateHeight();
        ...
        {
            _scrollViewer = RecommendedView.GetFirstDescendantOfType<ScrollViewer>();
