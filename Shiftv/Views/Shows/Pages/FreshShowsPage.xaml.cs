...
{
    public sealed partial class FreshShowsPage
    {
        ...
        public FreshShowsPageViewModel ViewModel { get { return (FreshShowsPageViewModel)DataContext; } }

        public FreshShowsPage()
        {
            InitializeComponent();
