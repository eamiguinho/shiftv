...
namespace Shiftv.ViewModels.Movies.Pages
{
    public class OscarsMoviesViewModel : MovieGridViewBase
    {
        ...
        public override sealed async void LoadData()
        {
            ...
            if(_topMoviesDownload == null || _topMoviesDownload.Data == null) _topMoviesDownload = await CoreServices.Movie.GetOscarsMovies();
